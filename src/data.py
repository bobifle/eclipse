...
skills = { sk['name'].lower(): sk for sk in content['skills']}
aptitudes = { apt['name'].lower(): apt for apt in content['aptitudes']}
pools = { pool['name'].lower(): pool for pool in content['pools']}
